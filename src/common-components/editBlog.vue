<template>
  <contain :sping="sping">
    ...
    <div class="title"><span class="info">标题：</span><Input maxlength="30" v-model="blog.title" show-word-limit
        placeholder="请输入标题..." style="max-width: 500px" /></div>
    <div class="title"><span class="info">简述：</span><Input maxlength="100" v-model="blog.description" show-word-limit
        placeholder="请输入描述..." style="max-width: 500px" /></div>
