  ...
  <contain class="page" :sping="sping" :isHaveData="isHaveData" :search="getBlogList">
    ...
    <List>
      <ListItem v-for="(blogObj, index) in blog_arr" :key="index">
        <ListItemMeta @click.native="previewBlog(blogObj['id'])" :description="blogObj['description']">
          <span slot="avatar">
            <svg t="1609063644144" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
              ...
              <path d="M512 512m-512 0a512 512 0 1 0 1024 0 512 512 0 1 0-1024 0Z" fill="#BDC3C7" p-id="9708" />
              <path
              ...
              <path d="M301.169778 439.068444h421.546666V584.817778H301.169778z" fill="#FABD6B" p-id="9710" />
              <path
              ...
              <path d="M642.844444 250.311111v523.377778h-58.140444V250.311111" fill="#E1E1E6" p-id="9712" />
              <path
